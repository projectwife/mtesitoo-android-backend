...
import mtesitoo.com.mtesitoo.logic.ProductService;
import mtesitoo.com.mtesitoo.model.Product;
import mtesitoo.com.mtesitoo.model.Seller;
          ...
          public void onResponse(String response) {
            ...
            try {
              ...
              for (int i = 0; i < jsonProducts.length(); ++i) {
                ...
                Product product =
                    new Product(jsonProduct.getString("name"),
                        jsonProduct.getString("description"), jsonProduct.getString("price"),
                        Uri.parse(jsonProduct.getString("thumb_image")), null /* special price */,
                        Seller.DUMMY);
                result.add(product);
              }
